...
"""This test is to test the Wifi SCC 5G Wifi D2D and 5G STA.
...
failed, other mediums will be tried. Both the D2D medium and STA are using the
same 5G channel.
...
_THROUGHPUT_LOW_TIP_RAW = (
    'This is a 5G SCC case. Check with the wifi chip vendor for any possible'
    ' firmware issue.'
)
_THROUGHPUT_LOW_TIP = (
...
class Scc5gAllWifiStaTest(nc_performance_test_base.NcPerformanceTestBase):
  ...
  def test_scc_5g_all_wifi_sta(self):
    """Test the performance for Wifi SCC with 5G Wifi D2D and 5G STA."""
