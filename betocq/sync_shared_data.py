...
class SharedData:
  """A container class for configuring shared data."""
...
def _shared_data_configs() -> Sequence[SharedData]:
  """Loads and parses the shared data configs."""
  results = []
...
def _resolve_output_files(config: SharedData) -> Sequence[str]:
...
def _generate_data_files(dest_dir: str) -> None:
  ...
  for data_config in _shared_data_configs():
