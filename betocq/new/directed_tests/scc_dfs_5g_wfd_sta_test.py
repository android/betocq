...
"""This test is to test the Wifi SCC with WFD and STA in a 5G DFS channel.
...
In this case, the feature is enabled for the target device so the WFD and STA
both are operating in the same DFS 5G channel.
...
Test steps:
  1. Connect discoverer to a 5G Wi-Fi network.
...
class SccDfs5gWfdStaTest(performance_test_base.PerformanceTestBase):
  """Test class for SCC with DFS 5G WFD and STA."""
  ...
  def test_scc_dfs_5g_wfd_sta(self):
    """Test the performance for SCC with DFS 5G WFD and STA."""
